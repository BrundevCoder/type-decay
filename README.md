![project image](README_img/image.png)
...
- `randomFontConfig`: This function returns all the data for the font! It returns the `data` object with the necessary settings to chance the fontFamily, fontWeight, color and textShadow (the shadow is random, may or may not appear)
...
![testing project](README_img/heveryone.png)

<br/>

![video testing project](README_img/testing_proj_vid.gif)